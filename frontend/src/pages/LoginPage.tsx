import { Anchor, Box, Button, Group, NumberInput, PasswordInput, Stack, Title } from "@mantine/core";
...
export default function LoginPage() {
  ...
  const [, setUser1] = useLocalStorage<User | null>({ key: 'user1', defaultValue: null });
  const [, setUser2] = useLocalStorage<User | null>({ key: 'user2', defaultValue: null });
...
// DO:validation 項目埋まっていない時は、submitできないようにできていない（通知付き）
  ...
  return (<>
    <Box maw={600} mx="auto">
    <Title order={2} mt={"md"}>Login</Title>
